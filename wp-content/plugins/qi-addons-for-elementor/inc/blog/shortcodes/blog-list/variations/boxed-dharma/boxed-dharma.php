...
if ( ! function_exists( 'qi_addons_for_elementor_add_blog_list_variation_boxed_dharma' ) ) {
	/**
	 ...
	 * @return array
	 */
	function qi_addons_for_elementor_add_blog_list_variation_boxed_dharma( $variations ) {
		$variations['boxed-dharma'] = esc_html__( 'Boxed Dharma', 'qi-addons-for-elementor' );

		return $variations;
	}

	add_filter( 'qi_addons_for_elementor_filter_blog_list_layouts', 'qi_addons_for_elementor_add_blog_list_variation_boxed_dharma' );
}

if ( ! function_exists( 'qi_addons_for_elementor_load_blog_list_variation_boxed_dharma_assets' ) ) {
	/**
	 ...
	 * @return bool
	 */
	function qi_addons_for_elementor_load_blog_list_variation_boxed_dharma_assets( $is_enabled, $params ) {

		if ( 'boxed-dharma' === $params['layout'] ) {
			$is_enabled = true;
		}
	...
	add_filter( 'qi_addons_for_elementor_filter_load_blog_list_assets', 'qi_addons_for_elementor_load_blog_list_variation_boxed_dharma_assets', 10, 2 );
}

if ( ! function_exists( 'qi_addons_for_elementor_register_blog_list_boxed_dharma_scripts' ) ) {
	/**
	 ...
	 * @return array
	 */
	function qi_addons_for_elementor_register_blog_list_boxed_dharma_scripts( $scripts ) {
	...
	add_filter( 'qi_addons_for_elementor_filter_blog_list_register_scripts', 'qi_addons_for_elementor_register_blog_list_boxed_dharma_scripts' );
}

if ( ! function_exists( 'qi_addons_for_elementor_register_blog_list_boxed_dharma_styles' ) ) {
	/**
	 * Function that register modules 3rd party scripts
	 *
	 * @param array $styles
	 ...
	 * @return array
	 */
	function qi_addons_for_elementor_register_blog_list_boxed_dharma_styles( $styles ) {
	...
	add_filter( 'qi_addons_for_elementor_filter_blog_list_register_styles', 'qi_addons_for_elementor_register_blog_list_boxed_dharma_styles' );
}

if ( ! function_exists( 'qi_addons_for_elementor_add_blog_list_options_boxed_dharma' ) ) {
	function qi_addons_for_elementor_add_blog_list_options_boxed_dharma( $options ) {
		$boxed_options = array();
	...
	add_filter( 'qi_addons_for_elementor_filter_blog_list_extra_options', 'qi_addons_for_elementor_add_blog_list_options_boxed_dharma' );
}
