...
if ( ! function_exists( 'stal_core_add_team_title_options' ) ) {
	/**
	 * Function that add title options for team module
	 */
	function stal_core_add_team_title_options( $tab ) {
	...
	add_action( 'stal_core_action_after_team_options_single', 'stal_core_add_team_title_options' );
}