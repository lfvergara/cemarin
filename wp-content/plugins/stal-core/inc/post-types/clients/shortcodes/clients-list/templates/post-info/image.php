...
if ( ! empty ( $client_image ) ) { ?>
	<span class="qodef-e-image">
		...
		<?php if( ! empty( $client_image ) ) { ?>
			<span class="qodef-e-logo" <?php qode_framework_inline_style( $init_image ); ?>>
				<?php echo wp_get_attachment_image( $client_image, 'full' ); ?>
			</span>
		<?php } ?>
		<?php if( ! empty( $client_hover_image ) ) { ?>
			<span class="qodef-e-hover-logo">
                <span class="qodef-m-split qodef-split--up" <?php qode_framework_inline_style( $hover_image ); ?>></span>
				<?php echo wp_get_attachment_image( $client_hover_image, 'full' ); ?>
                <span class="qodef-m-split qodef-split--down" <?php qode_framework_inline_style( $hover_image ); ?>></span>
			</span>
		<?php } ?>
		<?php if( ! empty( $link ) ) { ?>
			</a>
