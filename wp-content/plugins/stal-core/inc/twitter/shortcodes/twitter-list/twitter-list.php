...
if ( ! function_exists( 'stal_core_add_twitter_list_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function stal_core_add_twitter_list_shortcode( $shortcodes ) {
		if( qode_framework_is_installed( 'twitter' ) ) {
			$shortcodes[] = 'StalCoreTwitterListShortcode';
		}
		
		return $shortcodes;
	}
	
	add_filter( 'stal_core_filter_register_shortcodes', 'stal_core_add_twitter_list_shortcode' );
}

if ( class_exists( 'StalCoreListShortcode' ) ) {
	class StalCoreTwitterListShortcode extends StalCoreListShortcode {
		
		public function map_shortcode() {
			$this->set_shortcode_path( STAL_CORE_INC_URL_PATH . '/twitter/shortcodes/twitter-list' );
			$this->set_base( 'stal_core_twitter_list' );
			$this->set_name( esc_html__( 'Twitter List', 'stal-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays twitter list', 'stal-core' ) );
			...
			$this->set_option( array(
				...
				'field_type' => 'text',
				'title'      => esc_html__( 'Number of Tweets', 'stal-core' ),
				'group'      => esc_html__( 'Info', 'stal-core' )
			) );
			$this->set_option( array(
				'name'          => 'show_retweeted_text',
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Retweeted Text', 'stal-core' ),
			...
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Avatar Image', 'stal-core' ),
				'options'       => stal_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'stal-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Author Name', 'stal-core' ),
				'options'       => stal_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'stal-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Tweet Text', 'stal-core' ),
				'options'       => stal_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'stal-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Media Placeholder', 'stal-core' ),
			...
			$this->set_option( array(
				'name'          => 'show_date',
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Date', 'stal-core' ),
				'options'       => stal_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'stal-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Tweet Actions', 'stal-core' ),
				'options'       => stal_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'stal-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Twitter Link', 'stal-core' ),
				'options'       => stal_core_get_select_type_options_pool( 'no_yes' ),
				'default_value' => 'no',
				'group'         => esc_html__( 'Info', 'stal-core' )
			) );
		...
		public function render( $options, $content = null ) {
			...
			return stal_core_get_template_part( 'twitter/shortcodes/twitter-list', 'templates/twitter-list', '', $atts );
		}
