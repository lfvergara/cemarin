...
if ( ! function_exists( 'stal_core_get_contact_form_7_forms' ) ) {
	/**
	 ...
	 * @return array
	 */
	function stal_core_get_contact_form_7_forms( $enable_default = true ) {
		$options       = array();
		...
		if ( ! empty( $contact_forms ) ) {
			...
			$options[0] = esc_html__( 'No contact forms found', 'stal-core' );
		}
