...
if ( ! class_exists( 'StalCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class StalCoreDashboardRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'stal_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
	...
	StalCoreDashboardRestAPI::get_instance();
}