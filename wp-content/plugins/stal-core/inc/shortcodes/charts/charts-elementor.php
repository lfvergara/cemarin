...
class StalCoreElementorCharts extends \Elementor\Widget_Base{
	...
	public function set_object(){
			$this->object = qode_framework_get_framework_root()->get_shortcodes()->get_shortcode('stal_core_charts');
	}
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new StalCoreElementorCharts() );