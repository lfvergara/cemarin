	...
	<<?php echo esc_attr( $title_tag ); ?> class="qodef-e-title" <?php qode_framework_inline_style( $title_styles ); ?>>
		...
		<?php endif; ?>
			<span class="qodef-e-title-inner">
				<?php stal_core_template_part( 'shortcodes/icon-list-item', 'templates/parts/' . $icon_type, '', $params ) ?>
				<span class="qodef-e-title-text" <?php qode_framework_inline_style( $offset_styles ); ?>><?php echo esc_html( $title ); ?></span>
			</span>
		<?php if ( ! empty( $link ) ) : ?>
			</a>
		<?php endif; ?>
