...
if ( ! function_exists( 'stal_core_add_elegant_icons_to_collection' ) ) {
	function stal_core_add_elegant_icons_to_collection( $icons ) {
		$icons[] = 'StalCoreElegantIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'stal_core_add_elegant_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class StalCoreElegantIconsPack extends QodeFrameworkIconPack {
