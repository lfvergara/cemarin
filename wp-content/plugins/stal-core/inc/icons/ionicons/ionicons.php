...
if ( ! function_exists( 'stal_core_add_ionicons_to_collection' ) ) {
	function stal_core_add_ionicons_to_collection( $icons ) {
		$icons[] = 'StalCoreIonIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'stal_core_add_ionicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class StalCoreIonIconsPack extends QodeFrameworkIconPack {
