...
if ( ! function_exists( 'stal_core_add_linea_icons_to_collection' ) ) {
	function stal_core_add_linea_icons_to_collection( $icons) {
		$icons[] = 'StalCoreLineaIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'stal_core_add_linea_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class StalCoreLineaIconsPack extends QodeFrameworkIconPack {
