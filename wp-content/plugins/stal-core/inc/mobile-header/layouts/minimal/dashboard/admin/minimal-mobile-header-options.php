...
if ( ! function_exists( 'stal_core_add_minimal_mobile_header_options' ) ) {
	function stal_core_add_minimal_mobile_header_options( $page ) {
		
		$section = $page->add_section_element(
			array(
				'name'       => 'qodef_minimal_mobile_header_section',
				'title'      => esc_html__( 'Minimal Mobile Header', 'stal-core' ),
				'dependency' => array(
					'show' => array(
		...
		$section->add_field_element(
			array(
				...
				'title'       => esc_html__( 'Minimal Height', 'stal-core' ),
	...
	add_action( 'stal_core_action_after_mobile_header_options_map', 'stal_core_add_minimal_mobile_header_options' );
}