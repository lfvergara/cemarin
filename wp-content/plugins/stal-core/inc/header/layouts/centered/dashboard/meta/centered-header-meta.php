...
if ( ! function_exists( 'stal_core_add_centered_header_meta' ) ) {
	function stal_core_add_centered_header_meta( $page ) {
	...
	add_action( 'stal_core_action_after_page_header_meta_map', 'stal_core_add_centered_header_meta' );
}